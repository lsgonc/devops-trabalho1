...
public class Trabalho1DbMigrationService : ITransientDependency
{
    public ILogger<Trabalho1DbMigrationService> Logger { get; set; }
    ...
    public Trabalho1DbMigrationService(
        ...
        IEnumerable<ITrabalho1DbSchemaMigrator> dbSchemaMigrators)
    {
        ...
        Logger = NullLogger<Trabalho1DbMigrationService>.Instance;
    }
