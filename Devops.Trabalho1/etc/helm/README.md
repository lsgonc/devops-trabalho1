...
```
127.0.0.1 trabalho1-local-web
127.0.0.1 trabalho1-local-webgateway
127.0.0.1 trabalho1-local-authserver
```
...
Now, you can browse the URL: `https://trabalho1-local-web`
